...
export function AuthorityCard({a}:{a:DemoAuthority}){
  ...
  return (
    <div className="glass rounded-2xl p-4">
      <div className="flex items-start justify-between gap-3 border-b border-[#4A3B2C] pb-3">
        <div>
          <div className="serif text-2xl text-[#F2E8D5]">{a.title}</div>
      ...
      <button onClick={()=>setOpen(true)} className="mt-4 rounded-md border border-[#B08A4A] bg-[#2B221B] px-3 py-2 text-sm text-[#F2E8D5]">View Evidence</button>
