  ...
  return (
    <div className="min-h-screen py-8 md:py-12">
      <div className="mx-auto max-w-6xl px-2 md:px-4">
        <div className="grid-overlay rounded-[28px] border border-[#4A3B2C] bg-[#17130F]/80 p-6 md:p-10">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 text-[11px] uppercase tracking-[0.45em] text-[#C7A15A]">LEXNOVA</div>
            <h1 className="serif max-w-4xl text-5xl font-semibold text-[#F2E8D5] md:text-7xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link href="/workspace" className="rounded-md border border-[#B08A4A] bg-[#B08A4A] px-5 py-3 font-medium text-[#1a120d] transition hover:bg-[#C7A15A]">Enter Research Workspace</Link>
              <Link href="/research" className="rounded-md border border-[#4A3B2C] bg-transparent px-5 py-3 font-medium text-[#F2E8D5] transition hover:border-[#B08A4A] hover:text-[#F9F2E7]">View Demo</Link>
            </div>
